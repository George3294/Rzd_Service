...
class InfoIndexView(View):
    ...
    def get(self, request: HttpRequest) -> HttpResponse:
        return render(request, 'rcs_1/info-index.html')

class StationListView(ListView):
    """
    Список станций и какая-то информация о ней
    """
    template_name = 'rcs_1/info-list.html'
    ...
    def station_create(self, request: HttpRequest) -> HttpResponse:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                form.save()
                url = reverse("rcs_1/info-list.html")
                return redirect(url)
        else:
            form = StationForm()
        context = {
        ...
        return render(request, 'rcs_1/info-create.html', context=context)
...
class StationCreateView(CreateView):
    ...
    template_name = 'rcs_1/info-create.html'
    success_url = reverse_lazy("rcs_1:info-create")
...
class ArduinoCreateView(CreateView):
    ...
    template_name = 'rcs_1/arduino-create.html'
    success_url = reverse_lazy("rcs_1:arduino-create")
...
class MicrocomputerCreateView(CreateView):
    ...
    model = Microcomputer
    fields = "name", "temperature_info", "station"
    template_name = 'rcs_1/micro-create.html'
    success_url = reverse_lazy("rcs_1:micro-create")

class MicrocomputerListView(ListView):
    """
    Список микрокомпьютеров
    """
    template_name = "rcs_1/micro-list.html"
...
class ArduinoListView(ListView):
    ...
    Список Arduino
    """
    template_name = "rcs_1/arduino-list.html"
...
def usb_web(request: HttpRequest) -> HttpResponse:
    ...
    with open("arduino.csv", "r", encoding="utf-8") as file:
        for line in file.read().split("\n"):  # Про тестить maxsplit, что бы произвести разделение на несколько строк
            ...
            return render(request, "rcs_1/info-arduino.html", context=context)
...
class DataSensorListView(ListView):
    ...
    """
    template_name = "rcs_1/info-arduino.html"
